            ...
            >
              <div className='stepper-nav mb-5'>
                ...
                <div className='stepper-item' data-kt-stepper-element='nav'>
                  <h3 className='stepper-title'>{intl.formatMessage({ id: 'WIZARDS.STEP.ACCOUNT_INFO', defaultMessage: 'Account Info' })}</h3>
                </div>
                      ...
                      <div>
                        <button type='submit' className='btn btn-lg btn-primary me-3'>
                          <span className='indicator-label'>
                            {!isSubmitButton && intl.formatMessage({ id: 'WIZARDS.BUTTON.CONTINUE', defaultMessage: 'Continue' })}
                            {isSubmitButton && intl.formatMessage({ id: 'WIZARDS.BUTTON.SUBMIT', defaultMessage: 'Submit' })}
